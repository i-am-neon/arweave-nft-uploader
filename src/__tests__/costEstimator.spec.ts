...
import { getCostOfOneARInDollars, getCostToSavePathToArweaveInDollars, getCostToSavePathToArweaveInWinstons, winstonsToAR } from '../utils/costEstimator';
...
describe('Arweave cost estimator', () => {
    ...
    it('should get the cost in Winstons of saving a given directory', async () => {
        ...
        const spy_fileUtils_getPathSizeInBytes = jest.spyOn(fileUtils, 'getPathSizeInBytes')
            .mockReturnValueOnce(bytes);
        const spy_fileUtils_getArweavePriceForBytesInWinstons = jest.spyOn(arweaveUtils, 'getArweavePriceForBytesInWinstons')
    ...
    it('should get the cost in Dollars of saving a given directory', async () => {
        ...
        jest.spyOn(fileUtils, 'getPathSizeInBytes')
            .mockReturnValueOnce(bytes);
